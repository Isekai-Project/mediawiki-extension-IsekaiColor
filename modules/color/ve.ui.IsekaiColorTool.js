...
ve.ui.IsekaiColorNoneTool.static.title = OO.ui.deferMsg('isekai-vecmps-color-name-none');
...
ve.ui.commandRegistry.register(
    new ve.ui.Command(
        'colorNone', 'color', 'clear', { args: [], supportedSelections: ['linear', 'table'] }
    )
);
...
ve.ui.IsekaiColorPrimaryTool.static.title = OO.ui.deferMsg('isekai-vecmps-color-name-primary');
...
ve.ui.commandRegistry.register(
    new ve.ui.Command(
        'colorPrimary', 'color', 'set', { args: ['primary'], supportedSelections: ['linear', 'table'] }
    )
);
...
ve.ui.IsekaiColorSecondaryTool.static.title = OO.ui.deferMsg('isekai-vecmps-color-name-secondary');
...
ve.ui.commandRegistry.register(
    new ve.ui.Command(
        'colorSecondary', 'color', 'set', { args: ['secondary'], supportedSelections: ['linear', 'table'] }
    )
);
...
ve.ui.IsekaiColorInfoTool.static.title = OO.ui.deferMsg('isekai-vecmps-color-name-info');
...
ve.ui.commandRegistry.register(
    new ve.ui.Command(
        'colorInfo', 'color', 'set', { args: ['info'], supportedSelections: ['linear', 'table'] }
    )
);
...
ve.ui.IsekaiColorSuccessTool.static.title = OO.ui.deferMsg('isekai-vecmps-color-name-success');
...
ve.ui.commandRegistry.register(
    new ve.ui.Command(
        'colorSuccess', 'color', 'set', { args: ['success'], supportedSelections: ['linear', 'table'] }
    )
);
...
ve.ui.IsekaiColorWarningTool.static.title = OO.ui.deferMsg('isekai-vecmps-color-name-warning');
...
ve.ui.commandRegistry.register(
    new ve.ui.Command(
        'colorWarning', 'color', 'set', { args: ['warning'], supportedSelections: ['linear', 'table'] }
    )
);
...
ve.ui.IsekaiColorDangerTool.static.title = OO.ui.deferMsg('isekai-vecmps-color-name-danger');
...
ve.ui.commandRegistry.register(
    new ve.ui.Command(
        'colorDanger', 'color', 'set', { args: ['danger'], supportedSelections: ['linear', 'table'] }
    )
);